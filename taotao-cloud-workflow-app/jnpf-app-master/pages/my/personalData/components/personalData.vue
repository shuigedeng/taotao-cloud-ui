	...
	<view class="jnpf-wrap personalData">
		<u-form :model="dataForm" :errorType="['toast']" label-position="left" label-width="150" label-align="left"
			...
			<u-form-item label="性别">
				<jnpf-select v-model="dataForm.gender" placeholder="请选择我的性别" :options='genderOptions' :props='props'>
				</jnpf-select>
			</u-form-item>
			...
			<u-form-item label="出生年月">
				<jnpf-date-time type="date" v-model="dataForm.birthday" placeholder="请选择出生年月">
				</jnpf-date-time>
			</u-form-item>
