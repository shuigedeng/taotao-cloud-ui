...
export default {
  ...
  methods: {
    ...
    handleDel(id) {
      console.log("🚀 ~ file: index.vue ~ line 128 ~ handleDel ~ common.tipTitle", this.$t('common.tipTitle'))
      console.log("🚀 ~ file: index.vue ~ line 128 ~ handleDel ~ common.delTip", this.$t('common.delTip'))
