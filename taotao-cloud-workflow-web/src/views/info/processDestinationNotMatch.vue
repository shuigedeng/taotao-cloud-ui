    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" max-height="100%">
          ...
          <el-table-column prop="address" label="预警地点" />
...
import { getPageList, ExportData, changeStatus } from "@/api/info/processDestinationNotMatch";
import RemarkForm from "./components/PdnmForm";
export default {
  components: {
    RemarkForm,
  },
