    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" max-height="100%">
          ...
          <el-table-column prop="preCreatorTime" label="预警前位置时间" />
          <el-table-column prop="preAddress" label="预警前位置" />
          <el-table-column prop="creatorTime" label="预警时间" />
          <el-table-column prop="address" label="预警位置" />
...
import { getPageList, ExportData, changeStatus } from "@/api/info/index";
import RemarkForm from "./components/Form";
export default {
  components: {
    RemarkForm,
  },
