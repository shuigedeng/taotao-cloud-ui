    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" max-height="100%">
          ...
          <el-table-column prop="flowTaskStartAddress" label="流程发起地" />
          <el-table-column prop="flowTaskDestination" label="流程目的地" />
          <el-table-column prop="flowTaskReturnTime" label="返回时间" />
          <el-table-column prop="reportTime" label="三天两检提交日期" />
...
import {
  ...
  ExportData,
  changeStatus,
} from "@/api/info/returnProcessNotSubmitted";
import RemarkForm from "./components/RpnsForm";
export default {
  components: {
    RemarkForm,
  },
