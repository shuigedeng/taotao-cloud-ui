...
import { lodash, Service, moment, ContentTypeEnum, HttpConfig } from "@taotaocloud/core";
import { Axios, ContentTypeEnum as ContentTypeEnum2, HttpConfig as HttpConfig2, Service as Service2, lodash as lodash2, moment as moment2 } from "@taotaocloud/core";
...
const _DeploymentService = class extends BaseBpmnService {
  ...
  create(data) {
    ...
    formData.append("deployment-source", data.deploymentSource ? data.deploymentSource : "taotaocloud Cloud UI");
