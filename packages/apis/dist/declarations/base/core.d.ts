import type { Entity } from '@taotaocloud/core';
...
export type { AxiosHttpResult, OAuth2Token, Conditions, ConstantDictionary, Dictionary, EmptyObject, Entity, Page, Pageable, Pagination, Sort, Tree } from '@taotaocloud/core';
