...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/taotao--cloud--project-2025.04-red" alt="Downloads"/>
  <img src="https://img.shields.io/badge/spring-6.2.4-red" alt="Downloads"/>
  <img src="https://img.shields.io/badge/spring_boot-3.4.4-orange" alt="Downloads"/>
...
**taotao-cloud** (taotao云平台) 基于gradle8.13、jdk21, 支持graalvm21, 采用最新的spring 6.2.4、SpringBoot 3.4.4、SpringCloud 2024.0.1、SpringSecurity 6.4.4、Nacos 2.5.1、Mybatis-Plus 3.5.11、Redis 7.4.0等框架，开发的一款企业级微服务架构的云服务平台，
...
dependencyManagement{
  imports {
    mavenBom "io.github.shuigedeng:taotao-boot-dependencies:2025.04"
  }
}
...
dependencyManagement{
  imports {
    mavenBom "io.github.shuigedeng:taotao-cloud-dependencies:2025.04"
  }
}
...
* **主体框架**：采用最新的`Spring Boot 3.4.4`、`Spring Cloud 2024.0.1`、`Spring Cloud Alibaba 2023.0.3.2` 版本进行设计
