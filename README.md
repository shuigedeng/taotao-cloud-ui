...
**taotao-cloud(taotao云平台)**  基于**gradle9.2.1** 、**jdk25**, 支持**graalvm25**, 采用最新的**spring 7.0.2**、**SpringBoot 4.0.1**、**SpringCloud 2025.1.0**、**SpringSecurity 7.0.2**、**Nacos 3.1.1**、**Mybatis-Plus 3.5.16**、**Redis 7.4.0**等框架，开发的一款企业级微服务架构的云服务平台，
