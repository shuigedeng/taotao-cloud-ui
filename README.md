...
**taotao-cloud(taotao云平台)**  基于**gradle8.14.2** 、**jdk21**, 支持**graalvm21**, 采用最新的**spring 6.2.8**、**SpringBoot 3.5.5**、**SpringCloud 2025.0.0**、**SpringSecurity 6.5.0**、**Nacos 3.0.1**、**Mybatis-Plus 3.5.12**、**Redis 7.4.0**等框架，开发的一款企业级微服务架构的云服务平台，
...
* **主体框架**：采用最新的`Spring Boot 3.5.5`、`Spring Cloud 2025.0.0`、`Spring Cloud Alibaba 2023.0.3.3` 版本进行设计
