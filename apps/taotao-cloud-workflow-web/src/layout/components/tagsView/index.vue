<template>
  <div id="tags-view-container" class="tags-view-container">
    <el-link icon="icon-ym icon-ym-nav-prev" class="el-tabs__nav-prev el-tabs__btn" :underline="false"
      @click="prevBtn" />
    <el-link icon="icon-ym icon-ym-nav-next" class="el-tabs__nav-next el-tabs__btn" :underline="false"
      @click="nextBtn" />
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll">
      <router-link v-for="tag in visitedViews" ref="tag" :key="tag.path" :class="isActive(tag) ? 'active' : ''"
        ...
        <template v-else>
          <i :class="tag.meta.icon" class="tag-icon" v-if="(tag.meta && tag.meta.icon) && tagsIcon"></i><span>{{
  ...
  methods: {
    ...
    initTags() {
      ...
      for (const tag of affixTags) {
        // Must have tag name
        // 临时隐藏dashboard页面
        if (tag.name && tag.name != "dashboard") {
