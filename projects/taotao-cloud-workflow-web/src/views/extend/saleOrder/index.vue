<template>
  <div class="WORKFLOW-common-layout sale-order-main">
    <div class="WORKFLOW-common-layout-center">
      ...
      <div class="WORKFLOW-common-layout-main WORKFLOW-flex-main">
        ...
        <div class="sale-order-footer">
          <WORKFLOW-table :data="productEntryList" highlight-current-row @row-click="rowClick1">
          ...
          <WORKFLOW-table :data="childrenList" class="ml-10">
