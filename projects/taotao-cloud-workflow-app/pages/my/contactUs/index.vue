	...
	export default {
		data() {
			return {
				...
				tell: '400-6868-969',
				url: 'https://www.workflowsoft.com',
				showPopup: false,
				list: [{
						name: '微信公众号',
						title: '扫码关注官网微信公众号',
					...
					{
						name: '官方网站',
						title: 'www.workflowsoft.com',
						icon: 'ie',
						bcg: 'u-type-primary-bg'
					}
				],
				copyright: 'Copyright © 2022 滔滔信息技术有限公司出品',
				show: false
			}
		},
		onLoad() {
			...
			this.copyright = uni.getStorageSync('copyright') || 'Copyright © 2022 滔滔信息技术有限公司出品'
			setTimeout(() => {
				uni.hideLoading()
				this.show = true
			}, 800)
			...
			Jump(index) {
				switch (index) {
					...
					case 2:
						...
						// #ifndef APP-PLUS
						uni.navigateTo({
							url: '/pages/apply/externalLink/index?fullName=福建滔滔信息技术有限公司&url=' + encodeURIComponent(
								this.url)
						})
						// #endif
						break;
